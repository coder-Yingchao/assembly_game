...
import sys
from tianshou.env.pettingzoo_env import PettingZooEnv
from gym_env.ma_computer_assembly_env_AEC_v8 import ComputerAssemblyMultiAgentEnv
...
if __name__ == "__main__":
    ...
    if True:
        policy.load_state_dict(torch.load("log/assemblygame_v8/DQN_Relu/policy.pth"))
