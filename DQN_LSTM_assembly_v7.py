...
from tianshou.utils.net.common import Net, LSTMNet, Recurrent
...
if __name__ == "__main__":
    ...
    policy2 = DQNPolicy(model=net1,optim=optim1,
            discount_factor=0.9,
            estimation_step=3,
            target_update_freq=300,
            action_space= env.action_space)
    ...
    log_path = os.path.join(args.logdir, "assemblygame_v7", "DQN")
    ...
    def save_best_fn(policy):
        os.makedirs(os.path.join("log", "assemblygame_v7", "DQN"), exist_ok=True)
        model1_save_path = os.path.join("log", "assemblygame_v7", "DQN", "policy1_Rew2.pth")
        model2_save_path = os.path.join("log", "assemblygame_v7", "DQN", "policy.pth")
