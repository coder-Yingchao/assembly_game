...
from tianshou.utils.net.common import Net, Recurrent, BiLSTM
...
if __name__ == "__main__":
    ...
    if False:
        policy.load_state_dict(torch.load("log/assemblygame_v9/BCQ&BCQ/policy1_DQN.pth"))
    ...
    log_path = os.path.join(args.logdir, "assemblygame_desktop_random_v9", "DQN_BiLSTM")
    ...
    def save_best_fn(policy):
        os.makedirs(os.path.join("log", "assemblygame_desktop_random_v9", "DQN_BiLSTM"), exist_ok=True)

        model1_save_path = os.path.join("log", "assemblygame_desktop_random_v9", "DQN_BiLSTM", "policy.pth")
