...
if __name__ == "__main__":
    ...
    if False:
        policy.load_state_dict(torch.load("log/assemblygame_v8/BCQ&BCQ/policy1_DQN.pth"))
    ...
    log_path = os.path.join(args.logdir, "assemblygame_v8", "DQN_LSTM_1_layer")
    ...
    def save_best_fn(policy):
        os.makedirs(os.path.join("log", "assemblygame_v8", "DQN_LSTM_1_layer"), exist_ok=True)

        model1_save_path = os.path.join("log", "assemblygame_v8", "DQN_LSTM_1_layer", "policy.pth")
