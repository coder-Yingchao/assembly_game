...
if __name__ == "__main__":
    ...
    log_path = os.path.join(args.logdir, "assemblygame_desktop_v11", "DQNResNet_5")
    ...
    def save_best_fn(policy):
        os.makedirs(os.path.join("log", "assemblygame_desktop_v11", "DQNResNet_5"), exist_ok=True)

        model1_save_path = os.path.join("log", "assemblygame_desktop_v11", "DQNResNet_5", "policy.pth")
