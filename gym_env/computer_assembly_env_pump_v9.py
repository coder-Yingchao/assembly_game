...
import pygame
import random
from game.computer_assembly_game_pump_v7 import ComputerAssemblyGame
...
register(
    id='ComputerAssemblyEnv-pump-v9',  # Use an environment ID with a version number
    entry_point='gym_env.computer_assembly_env_pump_v9:ComputerAssemblyEnv',  # Module path : ClassName
)
