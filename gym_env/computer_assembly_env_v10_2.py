...
# for the new env v8. Obseration information don't contain fatigue info
register(
    id='ComputerAssemblyEnv-v10_2',  # Use an environment ID with a version number
    entry_point='gym_env.computer_assembly_env_v10_2:ComputerAssemblyEnv',  # Module path : ClassName
)
