...
# for the new env v8. add action mask.
register(
    id='ComputerAssemblyEnv-v11',  # Use an environment ID with a version number
    entry_point='gym_env.computer_assembly_env_v11:ComputerAssemblyEnv',  # Module path : ClassName
)
        ...
        self.observation_space = spaces.Dict(
            {
                ...
                "mask": spaces.Box(low=0, high=1, shape=(9,), dtype=np.int8),
            }
        )
