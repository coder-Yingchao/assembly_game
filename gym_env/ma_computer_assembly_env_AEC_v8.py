...
from game.computer_assembly_game_v6 import ComputerAssemblyGame
...
class ComputerAssemblyMultiAgentEnv(AECEnv):
    ...
    def step(self, action):
        ...
        if self._agent_selector.is_last():
            ...
            rewards, terminated = self.game.move_hands_simultaneously(self.state[self.agents[0]]-1, self.state[self.agents[1]]-1)
