...
register(
    id='ComputerAssemblyEnv-v8',  # Use an environment ID with a version number
    entry_point='gym_env.computer_assembly_env_v8:ComputerAssemblyEnv',  # Module path : ClassName
)
