...
register(
    id='ComputerAssemblyEnv-v9',  # Use an environment ID with a version number
    entry_point='gym_env.computer_assembly_env_v9:ComputerAssemblyEnv',  # Module path : ClassName
)
