...
if __name__ == "__main__":
    ...
    log_path = os.path.join(args.logdir, "assemblygame_pump_v9", "DQN_Transform_4")
    ...
    def save_best_fn(policy):
        os.makedirs(os.path.join("log", "assemblygame_pump_v9", "DQN_Transform_4"), exist_ok=True)

        model1_save_path = os.path.join("log", "assemblygame_pump_v9", "DQN_Transform_4", "policy.pth")
