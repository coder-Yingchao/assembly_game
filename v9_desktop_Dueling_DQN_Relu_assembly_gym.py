...
if __name__ == "__main__":
    ...
    log_path = os.path.join(args.logdir, "assemblygame_desktop_v9_2", "Dueling_DQN_Relu")
    ...
    def save_best_fn(policy):
        os.makedirs(os.path.join("log", "assemblygame_desktop_v9_2", "Dueling_DQN_Relu"), exist_ok=True)

        model1_save_path = os.path.join("log", "assemblygame_desktop_v9_2", "Dueling_DQN_Relu", "policy.pth")
