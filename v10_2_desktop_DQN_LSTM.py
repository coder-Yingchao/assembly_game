...
from gym_env.computer_assembly_env_v10_2 import ComputerAssemblyEnv
...
def make_env():
    env = gym.make('ComputerAssemblyEnv-v10_2')
    return env
...
if __name__ == "__main__":
    ...
    log_path = os.path.join(args.logdir, "assemblygame_desktop_v10", "v10_2_DQN_LSTM")
    ...
    def save_best_fn(policy):
        os.makedirs(os.path.join("log", "assemblygame_desktop_v10", "v10_2_DQN_LSTM"), exist_ok=True)

        model1_save_path = os.path.join("log", "assemblygame_desktop_v10", "v10_2_DQN_LSTM", "policy.pth")
