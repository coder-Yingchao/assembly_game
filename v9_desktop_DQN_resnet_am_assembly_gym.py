...
if __name__ == "__main__":
    ...
    if False:
        policy.load_state_dict(torch.load("log/assemblygame_desktop_v9/DQNResNet_2/policy.pth"))
    ...
    log_path = os.path.join(args.logdir, "assemblygame_desktop_v9_2", "DQNResNet_2")
    ...
    def save_best_fn(policy):
        os.makedirs(os.path.join("log", "assemblygame_desktop_v9_2", "DQNResNet_2"), exist_ok=True)

        model1_save_path = os.path.join("log", "assemblygame_desktop_v9_2", "DQNResNet_2", "policy.pth")
