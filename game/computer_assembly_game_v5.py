...
import  random
import pandas as pd
# The action of the robot is randomly generated based on the  executable tasks.
        ...
        if do_human == 0:
            ...
            for num_comp in range(len(self.components)):
                ...
                if comp.picked_up_by_hand1:
                    object_in_hand = True
            if object_in_hand:
                return self.move_hands_simultaneously(9, action_hand2)
            elif rand_task == -1:
                return self.move_hands_simultaneously(-1, action_hand2)
            else:
