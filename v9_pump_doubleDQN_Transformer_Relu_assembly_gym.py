...
if __name__ == "__main__":
    ...
    policy = DQNPolicy(model=net1,optim=optim1,
            ...
            action_space= env.action_space,is_double= True)
    ...
    log_path = os.path.join(args.logdir, "assemblygame_pump_random_v9", "DQN_Transform")
    ...
    def save_best_fn(policy):
        os.makedirs(os.path.join("log", "assemblygame_pump_random_v9", "DQN_Transform"), exist_ok=True)

        model1_save_path = os.path.join("log", "assemblygame_pump_random_v9", "DQN_Transform", "policy.pth")
    ...
    def train_fn(epoch, env_step):
        eps = max(1, 1 - epoch * 0.001)  # Example of linearly decreasing epsilon
