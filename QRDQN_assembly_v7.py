...
from tianshou.policy import DQNPolicy, MultiAgentPolicyManager, RandomPolicy, QRDQNPolicy
...
if __name__ == "__main__":
    ...
    # define policy
    policy2: QRDQNPolicy = QRDQNPolicy(
        model=net1,
        optim=optim,
    ...
    def save_best_fn(policy):
        ...
        model2_save_path = os.path.join("log", "assemblygame_v7", "QRDQN", "policy.pth")
