...
from tianshou.utils.net.common import Net, ActorCritic, ResidualAttentionNet, DQNResNet
from tianshou.utils.net.discrete import Actor
from gym_env.computer_assembly_env_v9 import ComputerAssemblyEnv
...
if __name__ == "__main__":
    ...
    envs = DummyVectorEnv([lambda: make_env() for _ in range(10)])
    test_envs = DummyVectorEnv([lambda: make_env() for _ in range(10)])
    ...
    log_path = os.path.join(args.logdir, "assemblygame_pump_random_v9", "DQNResNet_self_attention_06")
    ...
    def save_best_fn(policy):
        os.makedirs(os.path.join("log", "assemblygame_pump_random_v9", "DQNResNet_self_attention_06"), exist_ok=True)

        model1_save_path = os.path.join("log", "assemblygame_pump_random_v9", "DQNResNet_self_attention_06", "policy.pth")
    ...
    def train_fn(epoch, env_step):
        eps = max(1, 1 - epoch * 0.003)  # Example of linearly decreasing epsilon
