...
from tianshou.policy import DQNPolicy, MultiAgentPolicyManager, DiscreteBCQPolicy, ImitationPolicy, RainbowPolicy, C51Policy
...
if __name__ == "__main__":
    ...
    log_path = os.path.join(args.logdir, "assemblygame_pump_v9", "Rainbow")
    ...
    def save_best_fn(policy):
        os.makedirs(os.path.join("log", "assemblygame_pump_v9", "Rainbow"), exist_ok=True)

        model1_save_path = os.path.join("log", "assemblygame_pump_v9", "Rainbow", "policy.pth")
