...
from tianshou.policy import DQNPolicy, MultiAgentPolicyManager, DiscreteBCQPolicy, ImitationPolicy, QRDQNPolicy
...
if __name__ == "__main__":
    ...
    optim = torch.optim.Adam(net1.parameters(), lr=args.lr)
    # define policy
    ...
    log_path = os.path.join(args.logdir, "assemblygame_v7", "QRDQN")
    ...
    def save_best_fn(policy):
        os.makedirs(os.path.join("log", "assemblygame_v7", "QRDQN"), exist_ok=True)

        model1_save_path = os.path.join("log", "assemblygame_v7", "QRDQN", "policy.pth")
