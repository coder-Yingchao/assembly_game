...
if __name__ == "__main__":
    ...
    while running:
        ...
        if ros_sub_pub.done or first:
            print('first executing')
            observation = ros_sub_pub.state
            act = policy1.compute_action(observation, None, None)
            ros_sub_pub.task_num_publisher(Int32(act-1))
            first = False
        ...
        observation2, reward2, term2, truncated2, info2 = env.step(current_action_agent1)
