...
from gym_env.computer_assembly_env_v8 import ComputerAssemblyEnv
...
def make_env():
    env = gym.make('ComputerAssemblyEnv-v8')
    return env
...
if __name__ == "__main__":
    ...
    if False:
        policy1.load_state_dict(torch.load("log/assemblygame_v8/BCQ&BCQ/policy1_DQN.pth"))
    ...
    log_path = os.path.join(args.logdir, "assemblygame_v8", "DQN_Cross_entropy")
    ...
    def save_best_fn(policy):
        os.makedirs(os.path.join("log", "assemblygame_v8", "DQN_Cross_entropy"), exist_ok=True)

        model1_save_path = os.path.join("log", "assemblygame_v8", "DQN_Cross_entropy", "policy.pth")
