...
from tianshou.utils.net.common import Net, BiLSTM
...
if __name__ == "__main__":
    ...
    if False:
        policy.load_state_dict(torch.load("log/assemblygame_v7/BCQ&BCQ/policy1_DQN.pth"))
    ...
    log_path = os.path.join(args.logdir, "assemblygame_v7", "DQN_BiLSTM")
    ...
    def save_best_fn(policy):
        os.makedirs(os.path.join("log", "assemblygame_v7", "DQN_BiLSTM"), exist_ok=True)

        model1_save_path = os.path.join("log", "assemblygame_v7", "DQN_BiLSTM", "policy.pth")
